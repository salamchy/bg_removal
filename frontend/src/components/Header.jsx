...
const Header = () => {
  return (
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      {/* left side */}
      <div className="">
        <h1 className="text-4xl xl:text-5xl 2xl:text-6xl font-bold text-neutral-700 leading-tight">Removes the <br className="max-md:hidden" />
        ...
        <p className="my-6 text-[15px] text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur ratione in voluptatibus <br className="max-sm:hidden" /> accusamus error maxime fuga perferendis ducimus, nisi et est repellat assumenda.</p>
        <div>
